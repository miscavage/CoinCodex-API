...
class CoinCodex {
  ...
  get coins() {
    return {
       ...
       * @param {string} coinId - (Required) The unique internal id for the coin
       * @param {object} params - Parameters to pass through to the request
       * @param {string} params.start_date - (Required) The start date of the historical data snapshot in YYYY-MM-DD eg. 2018-01-01
       * @param {string} params.end_date - (Required) The end date of the historical data snapshot in YYYY-MM-DD eg. 2018-01-31
       * @param {string|numbers} params.samples [default: 1] - How many price values between the start_date and end_date to be included in the results.
       *   (i.e. if start_date: 2018-01-01, end_date: 2018-01-31, samples: 1. Only 1 value will be returned. If samples: 30, 30 values will be returned)
       * @returns {ReturnObject}
       */
